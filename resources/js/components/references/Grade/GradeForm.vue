<template>
    <div class="modal fade" id="gradeForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input v-model.trim="element.title" type="text" :class="{'is-invalid':errors.title}" class="form-control" id="title" maxlength="20">
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Значение:<span class="text-danger">*</span></label>
                        <input v-model.trim="element.value" type="number" :class="{'is-invalid':errors.value}" class="form-control" id="value">
                        <template v-if="errors.value">
                            <div class="invalid-feedback" v-for="error in errors.value">
                                {{ error }}
                            </div>
                        </template>
                    </div>
