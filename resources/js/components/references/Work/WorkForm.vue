<template>
    <div class="modal fade" id="workForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="title" class="form-label">Цвет:</label>
                        <input v-model="element.color" type="color" :class="{'is-invalid':errors.color}" class="form-control" id="color" maxlength="20">
                        <template v-if="errors.color">
                            <div class="invalid-feedback" v-for="error in errors.color">
                                {{ error }}
                            </div>
                        </template>
                    </div>
